...
- Publicado, estará disponible al Internet desde una dirección única y otros usuarios solo podrán anotar o citar tu documento, se podrá ver el listado de tus documentos públicos y los usuarios podrán suscribirse para ser notificados cuando se publique uno nuevo

El principal enfoque es hacer fácil anotar y citar entre documentos -tanto tuyos como de otros-, basándose en una de las [primeras ideas que se quería conseguir con los navegadores web](https://en.wikipedia.org/wiki/WorldWideWeb#History), intentar crear un Internet más conectado entre sí y haciendo posible y abriendo a todo el mundo la posibilidad de mantener un pequeño "blog" donde poder compartir o colaborar en documentos con el resto del mundo.