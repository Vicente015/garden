...
El principal enfoque es hacer fácil anotar y citar entre documentos -tanto tuyos como de otros-, basándose en una de las [primeras ideas de la Web](https://en.wikipedia.org/wiki/WorldWideWeb#History), intentar crear un Internet más conectado entre sí y haciendo posible y abriendo a todo el mundo la posibilidad de mantener un pequeño "blog" donde poder compartir o colaborar en documentos con el resto del mundo.